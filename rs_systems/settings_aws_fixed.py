...
ALLOWED_HOSTS = [
    '*',  # Allow all hosts for testing - restrict in production
    'localhost',
    '127.0.0.1',
...
INSTALLED_APPS = [
    ...
    'apps.technician_portal.apps.TechnicianPortalConfig',
    'apps.customer_portal.apps.CustomerPortalConfig',
    'apps.rewards_referrals.apps.RewardsReferralsConfig',
    'apps.scheduling.apps.SchedulingConfig',
    'apps.queue_management.apps.QueueManagementConfig',
    'apps.photo_storage.apps.PhotoStorageConfig',
...
if 'RDS_HOSTNAME' in os.environ:
    ...
    # Development/testing database (SQLite)
    DATABASES = {
        'default': {
